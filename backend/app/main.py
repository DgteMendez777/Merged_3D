...
from app.routes.pointcloud_midas import (router as pointcloud_midas_router)
...
from app.routes.pointcloud_midas import (set_pointcloud_midas_service)
...
from app.core.config import (SAM_MODEL_PATH, DEPTH_ANYTHING_MODEL_PATH, MIDAS_MODEL_PATH, ALLOWED_ORIGINS)
...
pointcloud_midas_service = PointCloudService(midas_service, sam_service)
